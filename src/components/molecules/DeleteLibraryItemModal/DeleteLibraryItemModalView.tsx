...
import type { DeleteLibraryItemModalViewProps } from './DeleteLibraryItemModalView.types'

export const DeleteLibraryItemModalView = ({ item, onCancel, onDelete, t }: DeleteLibraryItemModalViewProps) => {
