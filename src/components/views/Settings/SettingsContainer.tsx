...
import type { SettingsContainerProps } from './SettingsContainer.types'

export const SettingsContainer = ({ profile, theme, weightUnit, onSave, onThemeChange, onWeightUnitChange }: SettingsContainerProps) => {
