...
import type { ProgressContainerProps } from './ProgressContainer.types'
...
const getMeasurementProgress = (workouts, key) =>
  getProgress(
    workouts.filter(workout => workout[key] != null).sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime()),
...
export const ProgressContainer = ({ workouts, stats, weightUnit }: ProgressContainerProps) => {
