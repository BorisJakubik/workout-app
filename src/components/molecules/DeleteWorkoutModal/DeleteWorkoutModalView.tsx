...
import type { DeleteWorkoutModalViewProps } from './DeleteWorkoutModalView.types'

export const DeleteWorkoutModalView = ({ onCancel, onDelete, t }: DeleteWorkoutModalViewProps) => (
