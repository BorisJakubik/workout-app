...
import type { WorkoutDetailHeaderViewProps } from './WorkoutDetailHeaderView.types'

export const WorkoutDetailHeaderView = ({
  editing,
  menuOpen,
  menuRef,
  onBack,
      ...
      <div className="workout-actions" ref={menuRef}>
        ...
        {menuOpen && (
          <div className="workout-actions-menu" role="menu">
            ...
            <button className="danger" role="menuitem" onClick={onDeleteRequest}>
