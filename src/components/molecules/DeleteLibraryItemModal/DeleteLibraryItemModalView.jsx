...
export const DeleteLibraryItemModalView = ({ item, onCancel, onDelete, t }) => {
  ...
  return (
    <div className="modal-backdrop" onMouseDown={event => event.target === event.currentTarget && onCancel()}>
      <div className="delete-workout-modal" role="alertdialog" aria-modal="true" aria-labelledby="delete-library-title" aria-describedby="delete-library-description">
        <div className="delete-workout-icon"><AlertTriangle size={22} /></div>
        <div>
