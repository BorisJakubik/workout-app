...
import type { ExerciseDropdownContainerProps } from './ExerciseDropdownContainer.types'

export const ExerciseDropdownContainer = ({ exercises, categoryId, value, onChange }: ExerciseDropdownContainerProps) => {
