...
import type { CategoryDropdownViewProps } from './CategoryDropdownView.types'

export const CategoryDropdownView = ({ categories, dropdownRef, onSelect, onToggle, open, t, value }: CategoryDropdownViewProps) => {
